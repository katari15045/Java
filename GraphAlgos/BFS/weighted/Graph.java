...
public class Graph
{
    ...
    public void storeEdges(int startVertex, int endVertex, int weight)
    {
      outerList.get(startVertex).addInnerVertex(endVertex,weight);      
    }
    ...
    public void printAdjacencyList()
    {
        ...
        while( countOuter <= vertices )
        {
            ...
            while( iterator.hasNext() )
            {
                ...
                System.out.print( currentEdge.getEndVertex() + "(" + currentEdge.getWeight() + "), " );
            }

            System.out.println(" --- " + currentNode.getId() + " -> " + currentNode.getColor() + ", " + currentNode.getDistance() );
